...
def calculate_demographic_data(print_data=True):
    ...
    rich_percent_by_country = df['native-country'][df.salary == '>50K'].value_counts() / df['native-country'].value_counts()

    highest_earning_country = rich_percent_by_country.idxmax()
    highest_earning_country_percentage = (rich_percent_by_country.max() * 100).round(1)
